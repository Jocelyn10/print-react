    ...
    return (
      <div>
        ...
        <div style={{ display: "flex", padding: "20px 20px 20px 50px " }}>
          <div style={{ color: "Red", paddingRight: "10px", fontSize: "22px" }}>
            Email:
          </div>
          <div style={{ fontSize: "22px" }}>{email}</div>
        </div>
        <div style={{ display: "flex", padding: "20px 20px 20px 50px " }}>
          <div style={{ color: "Red", paddingRight: "10px", fontSize: "22px" }}>
            Password:
          </div>
          <div style={{ fontSize: "22px" }}>{password}</div>
        </div>
        <div style={{ display: "flex", padding: "20px 20px 20px 50px " }}>
          <div style={{ color: "Red", paddingRight: "10px", fontSize: "22px" }}>
            Pincode:
          </div>
          <div style={{ fontSize: "22px" }}>{pincode}</div>
        </div>
        <div style={{ display: "flex", padding: "20px 20px 20px 50px " }}>
          <div style={{ color: "Red", paddingRight: "10px", fontSize: "22px" }}>
            Address:
